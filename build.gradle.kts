...
tasks.register("relocatePluginJar", com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
    ...
    relocate("com.github.shynixn.mcutils", "com.github.shynixn.shyguild.lib.com.github.shynixn.mcutils")
}
...
tasks.register("pluginJarLatest", com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
    ...
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_17_R1/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R1/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R2/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R1/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R2/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R3/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R1/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R2/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R3/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R4/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R1/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R2/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R3/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R4/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R5/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R6/**")
    exclude("com/github/shynixn/shyguild/lib/com/github/shynixn/mcutils/common/FoliaMarker.class")
...
tasks.register("relocateLegacyPluginJar", com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
    ...
    relocate("com.github.shynixn.mcutils", "com.github.shynixn.shyguild.lib.com.github.shynixn.mcutils")
    relocate("com.github.shynixn.mccoroutine", "com.github.shynixn.shyguild.lib.com.github.shynixn.mccoroutine")
    relocate("com.github.shynixn.fasterxml", "com.github.shynixn.shyguild.lib.com.github.shynixn.fasterxml")
    relocate("kotlin", "com.github.shynixn.shyguild.lib.kotlin")
    relocate("kotlinx", "com.github.shynixn.shyguild.lib.kotlinx")
...
tasks.register("languageFile") {
    ...
    val contractFile = kotlinSrcFolder.resolve("com/github/shynixn/shyguild/contract/ShyGuildLanguage.kt")
    ...
    contractContents.add("package com.github.shynixn.shyguild.contract")
    ...
    contractContents.add("")
    contractContents.add("interface ShyGuildLanguage : LanguageProvider {")
    for (key in lines) {
    ...
    val implFile = kotlinSrcFolder.resolve("com/github/shynixn/shyguild/ShyGuildLanguageImpl.kt")
    val implContents = ArrayList<String>()
    implContents.add("package com.github.shynixn.shyguild")
    implContents.add("")
    implContents.add("import com.github.shynixn.mcutils.common.language.LanguageItem")
    implContents.add("import com.github.shynixn.shyguild.contract.ShyGuildLanguage")
    implContents.add("")
    implContents.add("class ShyGuildLanguageImpl : ShyGuildLanguage {")
